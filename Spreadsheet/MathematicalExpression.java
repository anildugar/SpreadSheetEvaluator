...
enum MathematicalExpressionType {
	PlaceHolder, RawValues
}

/*
 * This class represents a Mathematical Expression within a spreadsheet for a
 * spreadsheet cell.
 */
final class MathematicalExpression {
	...
	/*
	 * Constructor of a Mathematical Expression will do the following things. 1.
	 * Split the expression into individual symbols 2. Evaluate the expression type
	 * based on the individual symbols. 3. Evaluate and store all the dependencies
	 * for a given cell based on the individual expression symbols.
	 */
	...
	public ArrayList<String> getDependencySymbols() {
	...
	/*
	 * Check and determine whether the given expression is of type RawValues or
	 * Placeholder. If a given expression contains a spreadsheet cell as part of
	 * expression expression is of type placeholder.
	 */
